...
// The _interesting_ part about rest/spread though is the fact that it alwasy _copies_ the object and never mutates. 
...
// Lets say we have a library module that takes a default configuraiton object.
...
const parseData = ([tom, dick, harry, ...numbers]) => ({ tom, dick, harry, numbers })
