...
// Except, this time we'll explictly say we want object one to be the parent of any objects created from this set of instructions. 
function Mammal()  {
    this.mammal = true;
}
...
// Oh poop 💩 now all of our strings that reference this prototype object are now returning wierd stuff! Uh-oh!
